...
export const en = {
  ...
  privacy_deletionBody: "We don't yet have a self-serve \"delete my data\" button in the app. To request deletion of your player data, email us at:",
...
export const it: Record<keyof typeof en, string> = {
  ...
  privacy_deletionBody: "Al momento non abbiamo un pulsante \"cancella i miei dati\" self-service nell'app. Per richiedere la cancellazione dei tuoi dati di gioco, scrivici a:",
