...
export const en = {
  ...
  home_roomsTitle: "Rooms",
  home_roomsBody: "Play a private game with friends using a room code.",
  home_roomsCta: "Create or join a room",
  ...
  // Rooms (private multiplayer) — foundational keys for Pass 2's UI; error
  // messages mirror src/lib/store/errors.ts's room-related GameFlowError codes.
  room_nicknameLabel: "Nickname",
  room_codeLabel: "Room code",
  room_maxPlayersLabel: "Max players",
  room_roundCountLabel: "Rounds",
  room_create: "Create room",
  room_join: "Join room",
  room_leave: "Leave room",
  room_startGame: "Start game",
  room_reveal: "Reveal result",
  room_nextRound: "Next round",
  room_waitingForPlayers: "Waiting for players…",
  room_waitingForSubmissions: "Waiting for everyone to submit…",
  room_hostBadge: "Host",
  room_finalLeaderboard: "Final leaderboard",
  room_error_notFound: "Room not found.",
  room_error_full: "This room is full.",
  room_error_alreadyStarted: "This room has already started.",
  room_error_notHost: "Only the host can do that.",
  room_error_notMember: "You're not in this room.",
  room_error_alreadySubmitted: "You already submitted this round.",
  room_error_roundNotActive: "This round isn't active.",
  room_error_roundNotRevealed: "The result hasn't been revealed yet.",
  room_error_tooManyActiveRooms: "You already have too many active rooms.",
  room_error_tooManyJoinAttempts: "Too many attempts — try again in a minute.",
  room_error_notEnoughQuestions: "Not enough questions available right now.",
  room_error_invalidNickname: "Nickname must be 3-20 characters: letters, numbers, and underscores only.",
  room_error_invalidMaxPlayers: "Choose between 2 and 20 players.",
  room_error_invalidRoundCount: "Choose 5, 10, 15, or 20 rounds.",
  room_error_invalidCode: "Room code must be 5 characters.",
  room_error_unavailable: "Rooms aren't available right now.",
  room_error_generic: "Something went wrong with this room. Try again.",

  // Rooms — Pass 2 UI-specific keys
  room_entryBody: "Create a private room and share the code, or join one a friend started.",
  room_createTitle: "Create a room",
  room_joinTitle: "Join a room",
  room_copyCode: "Copy code",
  room_copyCodeCopied: "Copied!",
  room_copyInviteLink: "Copy invite link",
  room_playersCount: "{count} / {max} players",
  room_roundsConfigured: "{count} rounds",
  room_lobbyWaitingForHost: "Waiting for the host to start…",
  room_submitCta: "Lock in my answer",
  room_submittedCount: "{count} / {total} players have answered",
  room_waitingForHostReveal: "Waiting for the host to reveal…",
  room_waitingForHostNext: "Waiting for the host to continue…",
  room_roundResultsTitle: "Round {n} results",
  room_predictedShort: "predicted {pct}%",
  room_totalLabel: "Total",
  room_finishGame: "See final results",
  room_winner: "Winner",
...
export const it: Record<keyof typeof en, string> = {
  ...
  home_roomsTitle: "Stanze",
  home_roomsBody: "Gioca in privato con gli amici usando un codice stanza.",
  home_roomsCta: "Crea o entra in una stanza",
  ...
  // Rooms (multiplayer privato)
  room_nicknameLabel: "Nickname",
  room_codeLabel: "Codice stanza",
  room_maxPlayersLabel: "Numero massimo di giocatori",
  room_roundCountLabel: "Round",
  room_create: "Crea stanza",
  room_join: "Entra nella stanza",
  room_leave: "Esci dalla stanza",
  room_startGame: "Inizia la partita",
  room_reveal: "Rivela il risultato",
  room_nextRound: "Round successivo",
  room_waitingForPlayers: "In attesa di giocatori…",
  room_waitingForSubmissions: "In attesa che tutti rispondano…",
  room_hostBadge: "Host",
  room_finalLeaderboard: "Classifica finale",
  room_error_notFound: "Stanza non trovata.",
  room_error_full: "Questa stanza è piena.",
  room_error_alreadyStarted: "Questa stanza è già iniziata.",
  room_error_notHost: "Solo l'host può farlo.",
  room_error_notMember: "Non fai parte di questa stanza.",
  room_error_alreadySubmitted: "Hai già risposto per questo round.",
  room_error_roundNotActive: "Questo round non è attivo.",
  room_error_roundNotRevealed: "Il risultato non è ancora stato rivelato.",
  room_error_tooManyActiveRooms: "Hai già troppe stanze attive.",
  room_error_tooManyJoinAttempts: "Troppi tentativi — riprova tra un minuto.",
  room_error_notEnoughQuestions: "Al momento non ci sono abbastanza domande disponibili.",
  room_error_invalidNickname: "Il nickname deve avere 3-20 caratteri: lettere, numeri e underscore.",
  room_error_invalidMaxPlayers: "Scegli tra 2 e 20 giocatori.",
  room_error_invalidRoundCount: "Scegli 5, 10, 15 o 20 round.",
  room_error_invalidCode: "Il codice stanza deve avere 5 caratteri.",
  room_error_unavailable: "Le stanze non sono disponibili al momento.",
  room_error_generic: "Qualcosa è andato storto con questa stanza. Riprova.",

  // Rooms — chiavi UI del Pass 2
  room_entryBody: "Crea una stanza privata e condividi il codice, oppure entra in una stanza già creata da un amico.",
  room_createTitle: "Crea una stanza",
  room_joinTitle: "Entra in una stanza",
  room_copyCode: "Copia codice",
  room_copyCodeCopied: "Copiato!",
  room_copyInviteLink: "Copia link di invito",
  room_playersCount: "{count} / {max} giocatori",
  room_roundsConfigured: "{count} round",
  room_lobbyWaitingForHost: "In attesa che l'host inizi…",
  room_submitCta: "Conferma la mia risposta",
  room_submittedCount: "{count} / {total} giocatori hanno risposto",
  room_waitingForHostReveal: "In attesa che l'host riveli il risultato…",
  room_waitingForHostNext: "In attesa che l'host continui…",
  room_roundResultsTitle: "Risultati del round {n}",
  room_predictedShort: "previsto {pct}%",
  room_totalLabel: "Totale",
  room_finishGame: "Vedi la classifica finale",
  room_winner: "Vincitore",
