...
export const en = {
  ...
  privacy_deletionBody: "A dedicated contact method will be available for data deletion requests.",
...
export const it: Record<keyof typeof en, string> = {
  ...
  privacy_deletionBody: "Per richieste relative alla cancellazione dei dati, sarà disponibile un contatto dedicato.",
