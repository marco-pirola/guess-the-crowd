...
export const en = {
  ...
  result_youChose: "You chose {label}.",
  result_error: "Error",
  result_pointsOne: "{n} pt",
  result_pointsMany: "{n} pts",
  result_score: "Score",
  result_you: "You",
  result_crowd: "Crowd",
...
export const it: Record<keyof typeof en, string> = {
  ...
  result_youChose: "Hai scelto {label}.",
  result_error: "Scarto",
  result_pointsOne: "{n} punto",
  result_pointsMany: "{n} punti",
